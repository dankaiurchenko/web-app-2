...
<script>
    ...
    export default {
        ...
        mounted() {
            let self = this;
            http.get('/courses/'+ this.$route.params.id).then(function (response) {
                self.course = response.data;
                http.get('/users/'+self.course.lecturerId).then(function (response) {
            ...
            http.get('/courses/' + this.$route.params.id + '/realized')
